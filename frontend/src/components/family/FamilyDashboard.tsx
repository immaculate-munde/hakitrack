        ...
        <PageHeader
          ...
          action={
            <button
              ...
              className="site-ghost-btn site-ghost-btn-light px-4 py-2 text-xs tracking-[0.14em] uppercase"
            >
              Sign Out
            </button>
          }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-site-on-dark-muted">
                Dial *384*XYZ# → option 1 → enter {caseRecord.case_number.replace(/-/g, "")}
              </p>
            </div>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
          ...
          <div className="site-panel p-6">
            ...
            <p className="mt-6 text-xs leading-5 text-site-on-dark-muted">
              This dashboard is read-only. Contact the court clerk for official
              inquiries. Status changes appear here and on USSD immediately.
            </p>
          </div>
        </div>
